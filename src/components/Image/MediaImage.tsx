...
export default function MediaImage({ src, alt, priority, width, height, styleSheet }: MediaImageProps) {
  // StyledMediaImage is a Next Component
  // width and height properties are mandantory in the Image component of Next JS
  return (
    <StyledMediaImage src={src} alt={alt} width={width} height={height} priority={priority} style={styleSheet} />
  );
}
